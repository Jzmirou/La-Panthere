            ...
            .on("click", "[data-lightbox]", function (t) {
                ...
                var s = $(
                    '<div id="lightbox-modal" class="modal fade"><div class="modal-dialog"><div class="modal-content ' +
                        l +
                        ' blocs-lb-container"><button id="blocs-lightbox-close-btn" type="button" class="close-lightbox" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><div class="modal-body"><a href="#" class="prev-lightbox" aria-label="prev"><img width="16" height="22" src="./img/chevron-left-solid.svg"/></a><a href="#" class="next-lightbox" aria-label="next"><img width="16" height="22" src="./img/chevron-right-solid.svg"/></a><img id="lightbox-image" class="img-responsive" src="' +
                        e +
